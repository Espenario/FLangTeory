...
from CFG_2_GNF.cfg_parser import Parser
from CFG_2_GNF.cfg import CFGrammar
...
def main():
    ...
    with open('laba3/cfg.txt', mode="r", encoding="utf-8") as file:
    ...
    #for rule in greibach_normalized_cfg.rules:
        #print(rule.left.symbol, '->', *[el.symbol for el in rule.right])
    return greibach_normalized_cfg, ordered_nonterminals
