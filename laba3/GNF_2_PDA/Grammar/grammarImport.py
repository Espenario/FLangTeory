from GNF_2_PDA.Utils.Exceptions import IllegalVariableException
    ...
    for idx in range(2, data.__len__()):
        ...
        for character in rule:
            if character == '-' or character == '>' or character == '|':
                pass
            #elif character not in terminals and (not character.isupper()) and character != constant.LAMBDA:  gol
                #raise IllegalVariableException(character, rule)    gol
